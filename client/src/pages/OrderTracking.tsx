                                ...
                                {STEPS.map((step, index) => {
                                    ...
                                    return (
                                        <div key={step.id} className="flex items-center space-x-4">
                                            <div className={`relative z-10 flex items-center justify-center w-16 h-16 rounded-full border-4 transition-colors
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {booking.finalPrice ? `$${booking.finalPrice}` : 'Calculating...'}
                                </p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {booking.preferredPickupTime ? new Date(booking.preferredPickupTime).toLocaleString() : 'Not scheduled'}
                                </p>
                            </div>
                        </div>
                    </CardContent>
